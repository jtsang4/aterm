...
5. Run the fastest focused validators during iteration. Before handoff, run the meaningful repo validators plus the affected instrumentation/UI tests.
...
7. Ensure any recent-history, favorite, or persistence behavior you changed survives app relaunch when relevant.
8. Stop any processes you started and write a precise handoff that names the flows you tested and what remained undone.
